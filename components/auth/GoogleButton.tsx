...
// Google OAuth sign-in. Redirects to Supabase, which returns to
// /auth/callback?next=... to exchange the code for a session.
export default function GoogleButton({
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={loading}
      className="flex w-full items-center justify-center gap-2 rounded-full border border-gray-200 bg-white py-2.5 text-sm font-semibold text-gray-700 transition hover:bg-gray-50 disabled:opacity-60"
    >
