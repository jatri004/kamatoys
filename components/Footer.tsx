...
const socialLinks = [
  ...
  { icon: FaFacebook, label: "Facebook", href: "https://www.facebook.com/people/Kamadesires/61590450282413/", color: "#1877F2" },
            ...
            <div className="flex flex-col items-center sm:items-start gap-3">
              ...
              {socialLinks.map(({ icon: Icon, label, href, color, bg }) => (
                <a
                  ...
                  target="_blank"
                >
                  {/* Snapchat = white ghost with a thin black outline */}
                  <Icon
                    style={
                      label === "Snapchat"
                        ? { stroke: "#000000", strokeWidth: 0.7, paintOrder: "stroke" }
                        : undefined
                    }
                  />
                </a>
