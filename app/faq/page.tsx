...
export default function FAQPage() {
  ...
  const faqs = [
    ...
    { q: "Are your products body-safe?", a: "All products sold on KamaDesires are made from body-safe materials (medical-grade silicone, ABS plastic, borosilicate glass, stainless steel, or similar). We never sell products made from porous, toxic materials." },
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-14">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-500 text-sm">Everything you need to know about shopping with KamaDesires.</p>
      </div>
